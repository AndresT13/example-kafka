...
public class CalbackImplProducer implements Callback
{
    public static final Logger log = LoggerFactory.getLogger(CalbackImplProducer.class);
    @Override
    ...
    public static void main(String... args) {
        ...
        try(
            ...
            for (int i = 0; i < 10000; i++) {
                producer.send(new ProducerRecord<String, String>("des4j-topic", "des4j-key", "des4j-value"), new CalbackImplProducer() {
