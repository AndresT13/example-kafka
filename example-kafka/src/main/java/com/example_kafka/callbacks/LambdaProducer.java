...
public class LambdaProducer {
    ...
    public static final Logger log = LoggerFactory.getLogger(LambdaProducer.class);
    ...
    public static void main(String... args) {
        ...
        props.put("acks", "all"); // props.put("acks","all");
        ...
        try (Producer<String, String> producer = new KafkaProducer<>(props);) {
            ...
            for (int i = 0; i < 10000; i++) {
                producer.send(new ProducerRecord<String, String>("des4j-topic", "des4j-key", "des4j-value"), (metadata, exception) -> {
                    if (exception != null) {
